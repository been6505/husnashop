...
function ProductScreen({ match, history }) {
  ...
  return (
    <div>
      <Link to="/" className="btn btn-dark my-5" style={{borderRadius:'2rem'}}>
                      ...
                      <ListGroup variant="flush">
                        {product.countInStock > 0 && (
                          <ListGroup.Item>
                            <Row>
                              <Col>
                                <p className="p-1 fs-4">QUANTITY</p>
                              </Col>
                              <Col>
                                {/* <span>QUANTITY</span> */}
                                <span>
                        ...
                        {product.countInStock ? (
                          <ListGroup.Item>
                            <Button
                              className="w-100 fs-3 bg-danger"
